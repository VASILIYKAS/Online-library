...
1. Сгенерирует `pages/index1.html`, `pages/index2.html`, ... — страницы каталога.
2. Сгенерирует `pages/<slug>.html` — страницы чтения для каждой книги.
3. Запустит livereload на `http://127.0.0.1:5500/`.
